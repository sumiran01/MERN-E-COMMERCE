...
export const getDashboardstats = Trycatch(async (req, res, next) => {
    ...
    if (mycache.has("admin-stats"))
        ...
        const [thisMonthProducts, thisMonthUser, thisMonthOrders, LastMonthProducts, LastMonthUser, LastMonthOrders, productCount, usersCount, allorders, LastSixMonthOrders, categories, femaleUsercount, latestTransactions,] = await Promise.all([thisMonthProductsPromise,
...
export const getPiecharts = Trycatch(async (req, res, next) => {
    ...
    if (mycache.has("admin-pie-charts"))
        ...
        const [processingOrder, shippedOrder, deliveredOrder, categories, productCount, outofStock, Orders, allusers, adminUsers, customerUsers] = await Promise.all([
